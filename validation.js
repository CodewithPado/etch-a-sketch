...
let color = 'black';
//Create global boolean variable to tell whether you're in draw mode or not
let click = true; 
...
// Use display:none and display:hide to change visibility of text
...
/* Reset the grid by passing re-declaring squares and using forEach to change the background color*/
function resetGrid(){
  let squares = document.querySelectorAll('div');
  squares.forEach((div)=>(div.style.backgroundColor= 'white'));
}

/* Add an event listener to the body with if-else conditionals to tell what mode you're in (on or off)*/
// Make the click = !click
